...
## CONSTANTS:
REG_NUMBER = 11 # Satus register can't be written (read only).
...
class ev12aq600:
    ...
    def sync_pulse(self):
        ...
        When send_sync is set to high, the SYNC generator module detects the rising edge of the send_sync signal 
    ...
    def spi_wr_fifo_aq600(self, reg_addr):
        ...
        * reg_addr : positive integer : EV12AQ600 ADC register address, see datasheet
        spi_wr_fifo_aq600 loads address word first and then data word in SPI Master input FIFO to write ADC register identified by the address value.
        """
